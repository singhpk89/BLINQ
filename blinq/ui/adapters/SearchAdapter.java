...
public class SearchAdapter extends HeadboxBaseAdapter {
    ...
    private SearchHandler.SearchViewMode searchMode;
    ...
    public SearchAdapter(Context context, List<SearchResult> searchResults,
                         SearchHandler.SearchViewMode handlerType, Platform mergePlatform, SearchHandler searchHandler) {
        super();
    ...
    private int getIconToShowInFeed(SearchResult searchItem) {
        ...
        if (searchMode == SearchHandler.SearchViewMode.GENERAL) {

            lastMessagePlatform = searchItem.getLastMessagePlatform();

        } else if (searchMode == SearchHandler.SearchViewMode.MERGE
                || searchMode == SearchHandler.SearchViewMode.REMERGE) {
