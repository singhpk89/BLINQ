...
import com.blinq.ui.activities.search.SearchHandler.OnMergeItemSelectedListener;
...
public class MergeFragment extends Fragment implements OnClickListener,
    ...
    private SearchHandler.SearchViewMode mergeType;
    private int feedId;
    ...
    private CustomTypefaceTextView suggestionTitle;
    private CustomTypefaceTextView suggestionHint;
    ...
    private OnActionListener<List<SearchResult>> globalSearchListener = new OnActionListener<List<SearchResult>>() {
        ...
        public void onException(Throwable throwable) {
            ...
            isLoading = false;
            showLoadingProgressBar(false);
            if (throwable.getMessage().contains("Rate limit exceeded")) {
                activity.runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        Toast toast = Toast.makeText(activity, "Oops! Reached Twitter limit. Please try again in 15 minutes", Toast.LENGTH_LONG);
        ...
        public void onComplete(final List<SearchResult> response) {
            ...
            activity.runOnUiThread(new Runnable() {
                ...
                public void run() {
                    ...
                    searchHandler.setSearchResults(response);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        activity = (InstantMessageActivity) getActivity();
        ...
        displayLastSearchText = preferencesManager.getProperty(MergeFragment.DISPLAY_LAST_SEARCH_TEXT, false);
    ...
    private void init() {
        ...
        suggestionTitle = (CustomTypefaceTextView) root.findViewById(R.id.suggestion_title);
        suggestionHint = (CustomTypefaceTextView) root.findViewById(R.id.suggestion_hint);
    ...
    private void initPlatformIconAnimation() {
        ...
        rotateAnimation.setAnimationListener(new AnimationListener() {
            ...
            public void onAnimationEnd(Animation animation) {
                ...
                activity.displayInstantMessageView(platform);
    ...
    private void customizeSearchView() {
        ...
        searchHandler = new SearchHandler(this, searchResultList, searchView, mergeType, feedId);
        connectToSearchAPI();
    }
    ...
    public void onResume() {
        ...
        BlinqApplication.searchType = MergeSearchProvider.SearchActivityType.INSTANT;
    ...
    public void setMergeType(SearchHandler.SearchViewMode mergeType) {
    ...
    /**
     * Check if the Merge screen was idle to return it to home screen.
     */
    private void checkIdleState() {

        if (AppUtils.isActivityIdle(activity)) {
            Log.d(TAG, "Detect Merge screen idle state.");
            activity.finish();
